---
index: "2"
description: "Esta lección explora las operaciones fundamentales con vectores, como el escalado, la dependencia e independencia lineal, y las rectas y semirrectas generadas por vectores. También se abordan las operaciones de adición y sustracción de vectores, destacando su relevancia en aplicaciones prácticas."
...
{/* temas: [
    ...
    'Regla del paralelogramo. y sus propiedade'
]*/}
